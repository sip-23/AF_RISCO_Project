        ...
        <div className="min-h-screen flex flex-col bg-background">
            ...
            <main className="flex-1 pt-28 pb-28 px-4">
                <div className="max-w-6xl mx-auto text-center">
                    ...
                    <h2 className="text-2xl font-bold text-[#124E57] mb-4">Emerging Risks</h2>
                    <p className="text-gray-600">Emerging risks analysis content coming soon...</p>
                </div>
            </main>
            <Footer />
        </div>
